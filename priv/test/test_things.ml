...
let p2 = function
  | Sexp.List
      [ Sexp.List [ Atom a; Sexp.List [ Atom b; Atom c ]; Sexp.List [ Atom d; Atom e ] ]
      ; Sexp.List [ Atom f; Sexp.List [ Atom g; Atom h ]; Sexp.List [ Atom i; Atom j ] ]
      ]
    when String.equal a "sprite"
